...
// deterministic offset/infinite cache keys and thin option builders over TanStack. The contract types
// live in `@plainworks/std` (surfaced from the `query` root barrel); the URL builder `buildListQuery`
// lives in `@plainworks/http`. No logic here.
