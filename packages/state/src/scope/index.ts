...
// carry no host access, so they live in the `.` entry: the scope contract, the memory scope, and
// the serializers a host-backed scope composes in.
export { memoryScope } from "./memory"
export type { PersistedVersioning, Scope, SourceSpec } from "./scope"
