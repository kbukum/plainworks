...
type TabsListVariantSchema = {
  variant: Record<"default" | "line", string>
}

const tabsListVariants: ReturnType<typeof cva<TabsListVariantSchema>> = cva<TabsListVariantSchema>(
