...
type FieldVariantSchema = {
  orientation: Record<"vertical" | "horizontal" | "responsive", string>
}

const fieldVariants: ReturnType<typeof cva<FieldVariantSchema>> = cva<FieldVariantSchema>(
