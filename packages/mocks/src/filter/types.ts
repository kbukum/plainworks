 ...
 * vendored: it is the canonical contract owned by `@plainworks/std` (the lowest layer, which both the
 * `http` serializer and this parser bind to), re-exported here so the mock's filter types and its
