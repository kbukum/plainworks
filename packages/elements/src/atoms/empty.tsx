...
type EmptyMediaVariantSchema = {
  variant: Record<"default" | "icon", string>
}

const emptyMediaVariants: ReturnType<typeof cva<EmptyMediaVariantSchema>> =
  cva<EmptyMediaVariantSchema>(
