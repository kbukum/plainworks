...
type BadgeVariantSchema = {
  variant: Record<"default" | "secondary" | "destructive" | "outline" | "ghost" | "link", string>
}

const badgeVariants: ReturnType<typeof cva<BadgeVariantSchema>> = cva<BadgeVariantSchema>(
