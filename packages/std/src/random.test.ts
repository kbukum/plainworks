...
// Golden vector: locks the exact mulberry32 seed→sequence mapping so an accidental algorithm
// change fails loudly instead of silently shifting every consumer's fixtures.
