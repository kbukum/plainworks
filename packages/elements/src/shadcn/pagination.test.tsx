...
function Example() {
  return (
    <Pagination aria-label="Search results pages">
      <PaginationContent>
        <PaginationItem>
          {/* Upstream renders links through Base UI Button, which stamps role="button". */}
          <PaginationPrevious href="/search?page=1" role="link" />
        </PaginationItem>
        <PaginationItem>
          <PaginationLink href="/search?page=1" role="link">
            1
          </PaginationLink>
        </PaginationItem>
        <PaginationItem>
          <PaginationLink href="/search?page=2" role="link" isActive>
            2
          </PaginationLink>
        </PaginationItem>
        <PaginationItem>
        ...
        <PaginationItem>
          <PaginationNext href="/search?page=3" role="link" />
        </PaginationItem>
      </PaginationContent>
    </Pagination>
  )
