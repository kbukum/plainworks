 ...
 * backoff, timeout/deadline composition, retry driving, and a bounded backpressure queue. Written
 * once here at L0 so no caller forks its own copy. Re-export-only barrel; implementation lives in
