...
- **TSDoc / comments.** Write `/** */` and `//` prose naturally without arbitrary column breaks; preserve tags, directives, lists, tables, and code examples. Do not join separate comment paragraphs.
